...
struct base_ID3D11Device1
    : ID3D11Device1
{
    explicit base_ID3D11Device1(ID3D11Device1 *impl);
    virtual ~base_ID3D11Device1() {}
    ...
    HRESULT STDMETHODCALLTYPE CreateBlendState1(D3D11_BLEND_DESC1 const* pBlendStateDesc, ID3D11BlendState1** ppBlendState) override;
    HRESULT STDMETHODCALLTYPE CreateRasterizerState1(D3D11_RASTERIZER_DESC1 const* pRasterizerDesc, ID3D11RasterizerState1** ppRasterizerState) override;
    HRESULT STDMETHODCALLTYPE CreateDeviceContextState(UINT Flags, D3D_FEATURE_LEVEL const* pFeatureLevels, UINT FeatureLevels, UINT SDKVersion, REFIID EmulatedInterface, D3D_FEATURE_LEVEL* pChosenFeatureLevel, ID3DDeviceContextState** ppContextState) override;
...
public:
    ID3D11Device1 *impl() const;

private:
    ID3D11Device1 *impl_;
    unique_ptr<ID3D11Device> parent_base_;
};
