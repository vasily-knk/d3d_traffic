...
struct base_ID3D11DeviceContext1
    : ID3D11DeviceContext1
{
    explicit base_ID3D11DeviceContext1(ID3D11DeviceContext1 *impl);
    virtual ~base_ID3D11DeviceContext1() {}

    void STDMETHODCALLTYPE CopySubresourceRegion1(ID3D11Resource* pDstResource, UINT DstSubresource, UINT DstX, UINT DstY, UINT DstZ, ID3D11Resource* pSrcResource, UINT SrcSubresource, D3D11_BOX const* pSrcBox, UINT CopyFlags) override;
    void STDMETHODCALLTYPE UpdateSubresource1(ID3D11Resource* pDstResource, UINT DstSubresource, D3D11_BOX const* pDstBox, void const* pSrcData, UINT SrcRowPitch, UINT SrcDepthPitch, UINT CopyFlags) override;
    ...
    void STDMETHODCALLTYPE VSSetConstantBuffers1(UINT StartSlot, UINT NumBuffers, ID3D11Buffer* const* ppConstantBuffers, UINT const* pFirstConstant, UINT const* pNumConstants) override;
    void STDMETHODCALLTYPE HSSetConstantBuffers1(UINT StartSlot, UINT NumBuffers, ID3D11Buffer* const* ppConstantBuffers, UINT const* pFirstConstant, UINT const* pNumConstants) override;
    void STDMETHODCALLTYPE DSSetConstantBuffers1(UINT StartSlot, UINT NumBuffers, ID3D11Buffer* const* ppConstantBuffers, UINT const* pFirstConstant, UINT const* pNumConstants) override;
    void STDMETHODCALLTYPE GSSetConstantBuffers1(UINT StartSlot, UINT NumBuffers, ID3D11Buffer* const* ppConstantBuffers, UINT const* pFirstConstant, UINT const* pNumConstants) override;
    void STDMETHODCALLTYPE PSSetConstantBuffers1(UINT StartSlot, UINT NumBuffers, ID3D11Buffer* const* ppConstantBuffers, UINT const* pFirstConstant, UINT const* pNumConstants) override;
    void STDMETHODCALLTYPE CSSetConstantBuffers1(UINT StartSlot, UINT NumBuffers, ID3D11Buffer* const* ppConstantBuffers, UINT const* pFirstConstant, UINT const* pNumConstants) override;
    ...
    void STDMETHODCALLTYPE ClearView(ID3D11View* pView, FLOAT const Color[4], D3D11_RECT const* pRect, UINT NumRects) override;
    void STDMETHODCALLTYPE DiscardView1(ID3D11View* pResourceView, D3D11_RECT const* pRects, UINT NumRects) override;
...
public:
    ID3D11DeviceContext1 *impl() const;

private:
    ID3D11DeviceContext1 *impl_;
    unique_ptr<ID3D11DeviceContext> parent_base_;
};
